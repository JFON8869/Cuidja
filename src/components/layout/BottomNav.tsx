...
import { Home, PlusCircle, User, ShoppingCart, Wrench } from 'lucide-react';
        ...
        {navItems.map(({ href, label, icon: Icon, auth: requiresAuth }) => {
          ...
          return (
            <Link
              ...
              href={finalHref}
              className={cn(
                'flex h-full w-full flex-col items-center justify-center gap-1 rounded-md p-2 text-xs font-medium transition-colors',
                isActive

...
export default function SellerOrdersPage() {
  ...
  const { data: requests, isLoading: areRequestsLoading } = useCollection<WithId<ServiceRequest>>(
    requestsQuery
  );

  const isLoading = isUserLoading || isStoreLoading || (storeId && areOrdersLoading) || areRequestsLoading;
      ...
      <main className="flex-1 overflow-y-auto">
        <Tabs defaultValue="products" className="w-full">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="products">Produtos ({orders?.length || 0})</TabsTrigger>
            <TabsTrigger value="services">Serviços ({requests?.length || 0})</TabsTrigger>
          </TabsList>
          <TabsContent value="products">
              {isLoading ? renderOrderSkeleton() : (
          ...
          <TabsContent value="services">
             {isLoading ? renderRequestSkeleton() : (
